...
if (!dir.exists(here("figs", "cna_affected"))) {
  dir.create(here("figs", "cna_affected"), recursive = TRUE, mode="0755")
}
rez <- gtsave(gtable, here::here("figs", "cna_affected", "affected_counts_table.png"),
...
savepic(gg, here::here("figs", "cna_affected", "vpv_completeness"), 
...
savepic(gg, here::here("figs", "cna_affected", "monpct.prod_vend_version2"), 
        height = 3.5, width = 7, open = FALSE, caption=TRUE, dpi=300)
```
...
gg <- ggplot(url_pub, aes(month, pct, color=colfill)) + 
  ...
  theme(plot.title = element_text(family=mainfont, face="italic", size=11))
savepic(gg, here::here("figs", "cna_affected", "monpct.containers.cna.affected.collectionURL"), 
        height = 3.5, width = 7, open = FALSE, caption=TRUE, dpi=300)
```
...
savepic(gg, here::here("figs", "cna_affected", "cnapct.affected.collectionURL"), 
...
savepic(gg, here::here("figs", "cna_affected", "cnapct2020.affected.collectionURL"), 
        height = 4, width = 7, open = FALSE, caption=TRUE, dpi=300)
...
gg <- ggplot(toplot, aes(n, pct, label=cna)) +
  ...
  theme(panel.grid = element_line(color="gray95"),
        plot.title = element_text(family=mainfont, face="italic", size=11))
savepic(gg, here::here("figs", "cna_affected", "cna_uniq.affected.collectionURL"), 
        height = 3.5, width = 7, open = FALSE, caption=TRUE, dpi=300) 
```
...
gg <- ggplot(url_pub, aes(month, pct, color=colfill)) + 
  ...
  labs(title = paste("Percent of Published CVEs with values in", curfield)) +
  theme(plot.title = element_text(family=mainfont, face="italic", size=11))
savepic(gg, here::here("figs", "cna_affected", "monpct.affected.cpes"), 
        height = 3.5, width = 7, open = FALSE, caption=TRUE, dpi=300)
...
fname <- paste0("cnapct_", gsub("containers.cna.", "", curfield))
savepic(gg, here::here("figs", "cna_affected", fname),
        height = 4, width = 7, open = FALSE, caption=TRUE, dpi=300)

```

![percent by cna for `curfield`](`r paste0("figs/cna_affected/", fname, ".png")`)
...
![percent by cna of `curfield`](`r paste0("figs/cna_affected/", fname, ".png")`)
